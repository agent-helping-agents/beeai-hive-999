...
func main() {
	...
	fmt.Println("==========================================")
	fmt.Println("Claude can now read files, list directories, AND run shell commands!")
	...
	for {
		...
		// Send message to Claude with file reading, listing, and command execution capabilities
